...
GRANT CREATE, INSERT, SELECT, UPDATE on mysql_cluster.* to 'ECOM'@'%';
GRANT CREATE ON CART_ITEMS TO ECOM;
GRANT CREATE ON CATEGORY TO ECOM;
GRANT CREATE ON ITEM TO ECOM;
GRANT CREATE ON ITEM_CATEGORY TO ECOM;
GRANT CREATE, SELECT ON ORDERS TO ECOM;
...
REVOKE CREATE ON CATEGORY FROM ECOM;
REVOKE CREATE ON ITEM FROM ECOM;
REVOKE CREATE ON ITEM_CATEGORY FROM ECOM;
REVOKE CREATE ON ORDERS FROM ECOM;
REVOKE CREATE ON SHOPPING_CART FROM ECOM;
REVOKE CREATE ON STORE_USER FROM ECOM;
